...
import {
  ArrowRight, Train, ShieldCheck, MapPin, Clock3, Star, Users, Ticket,
} from "lucide-react";
...
const features = [
  { icon: ShieldCheck, title: "100% Secure Booking" },
  { icon: Clock3, title: "Fast Tatkal Booking" },
  { icon: MapPin, title: "7000+ Railway Stations" },
];

const stats = [
  { value: "2M+", label: "Happy Travelers", icon: Users },
  { value: "13K+", label: "Daily Trains", icon: Train },
  { value: "7000+", label: "Stations", icon: MapPin },
...
export default function Hero() {
  return (
    <section
      ...
      style={{
        backgroundImage: `
          linear-gradient(to bottom right, rgba(10,22,40,0.96), rgba(18,57,142,0.92), rgba(9,29,75,0.97)),
    ...
    >
      {/* Background Blur */}
      <div className="absolute -top-20 -left-20 h-80 w-80 rounded-full bg-orange-400/20 blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 lg:py-28">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              {features.map((feature, index) => {
                ...
                return (
                  <div key={index}
                    ...
                    <Icon size={28} className="text-orange-400 mb-3" />
              ...
              {stats.map((item, index) => {
                ...
                return (
                  <div key={index}
                    ...
                    <Icon size={26} className="mx-auto text-orange-500 mb-3" />
                    <h2 className="text-3xl font-bold text-[#0A1628]">{item.value}</h2>
          ...
          {/* RIGHT SIDE — Train Card with background image */}
          <motion.div
            variants={floating} animate="animate"
            className="relative hidden lg:flex justify-center"
          >
            {/* Glow */}
            <div className="absolute w-96 h-96 rounded-full bg-orange-400/20 blur-3xl pointer-events-none" />

            {/* Main Card */}
            <div className="relative rounded-3xl shadow-2xl overflow-hidden w-[420px]">
              ...
              <div
                ...
                style={{
                  backgroundImage: `
                    linear-gradient(to bottom right, rgba(10,22,40,0.88), rgba(10,22,40,0.75)),
              ...
              >
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-sm opacity-80">Premium Express</p>
                    <h2 className="text-2xl font-bold mt-1">Vande Bharat</h2>
                  </div>
                  <Train size={42} className="text-orange-400" />
                </div>
              </div>
              ...
              <div className="bg-white p-7 space-y-6">
                <div className="flex justify-between">
                  <div>
                    ...
                    <h3 className="font-bold text-lg">New Delhi</h3>
                    <p className="text-sm text-gray-500">06:00 AM</p>
                  </div>
                  <ArrowRight className="text-orange-500 mt-5" />
                  <div className="text-right">
                    <p className="text-gray-400 text-sm">TO</p>
                    <h3 className="font-bold text-lg">Chandigarh</h3>
                ...
                <div className="border-t border-gray-200 pt-5">
                  <div className="flex justify-between">
                    <div>
                      ...
                      <h3 className="font-semibold">3h 30m</h3>
                    </div>
                    <div>
                      <p className="text-gray-500">Seats</p>
                      <h3 className="text-green-600 font-bold">Available 152</h3>
                    </div>
                    <div>
                      <p className="text-gray-500">Fare</p>
                      <h3 className="text-orange-500 font-bold">₹945</h3>
                    </div>
                  </div>
                </div>
