...
import SmartAssistPanel   from "../components/SmartAssist/SmartAssistPanel";
import BookingReadiness   from "../components/SmartAssist/BookingReadiness";
import BookingStrategyReport from "../components/SmartAssist/BookingStrategyReport";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-[#0A1628] text-white px-6 py-5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {date && <span className="bg-white/10 px-3 py-1 rounded-full text-xs">{date}</span>}
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          {/* Right — Smart Assist Sidebar */}
          {!loading && !error && sorted.length > 0 && (
            <div className="w-full lg:w-80 shrink-0 space-y-4 lg:sticky lg:top-20 self-start">
              <SmartAssistPanel trains={sorted} origin={from} />
              <BookingReadiness />
              <BookingStrategyReport ranked={sorted} />
            </div>
          )}
